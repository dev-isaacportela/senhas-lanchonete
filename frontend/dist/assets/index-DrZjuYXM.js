 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,D){var B=z.length;z.push(D);e:for(;0<B;){var S=B-1>>>1,$=z[S];if(0<i($,D))z[S]=D,z[B]=$,B=S;else break e}}function r(z){return z.length===0?null:z[0]}function n(z){if(z.length===0)return null;var D=z[0],B=z.pop();if(B!==D){z[0]=B;e:for(var S=0,$=z.length,ne=$>>>1;S<ne;){var k=2*(S+1)-1,T=z[k],V=k+1,M=z[V];if(0>i(T,B))V<$&&0>i(M,T)?(z[S]=M,z[V]=B,S=V):(z[S]=T,z[k]=B,S=k);else if(V<$&&0>i(M,B))z[S]=M,z[V]=B,S=V;else break e}}return D}function i(z,D){var B=z.sortIndex-D.sortIndex;return B!==0?B:z.id-D.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var u=[],d=[],x=1,y=null,p=3,v=!1,g=!1,j=!1,N=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(z){for(var D=r(d);D!==null;){if(D.callback===null)n(d);else if(D.startTime<=z)n(d),D.sortIndex=D.expirationTime,t(u,D);else break;D=r(d)}}function w(z){if(j=!1,h(z),!g)if(r(u)!==null)g=!0,qe(b);else{var D=r(d);D!==null&&He(w,D.startTime-z)}}function b(z,D){g=!1,j&&(j=!1,f(P),P=-1),v=!0;var B=p;try{for(h(D),y=r(u);y!==null&&(!(y.expirationTime>D)||z&&!m());){var S=y.callback;if(typeof S=="function"){y.callback=null,p=y.priorityLevel;var $=S(y.expirationTime<=D);D=e.unstable_now(),typeof $=="function"?y.callback=$:y===r(u)&&n(u),h(D)}else n(u);y=r(u)}if(y!==null)var ne=!0;else{var k=r(d);k!==null&&He(w,k.startTime-D),ne=!1}return ne}finally{y=null,p=B,v=!1}}var _=!1,E=null,P=-1,U=5,I=-1;function m(){return!(e.unstable_now()-I<U)}function O(){if(E!==null){var z=e.unstable_now();I=z;var D=!0;try{D=E(!0,z)}finally{D?W():(_=!1,E=null)}}else _=!1}var W;if(typeof c=="function")W=function(){c(O)};else if(typeof MessageChannel<"u"){var F=new MessageChannel,ke=F.port2;F.port1.onmessage=O,W=function(){ke.postMessage(null)}}else W=function(){N(O,0)};function qe(z){E=z,_||(_=!0,W())}function He(z,D){P=N(function(){z(e.unstable_now())},D)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){g||v||(g=!0,qe(b))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return r(u)},e.unstable_next=function(z){switch(p){case 1:case 2:case 3:var D=3;break;default:D=p}var B=p;p=D;try{return z()}finally{p=B}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,D){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var B=p;p=z;try{return D()}finally{p=B}},e.unstable_scheduleCallback=function(z,D,B){var S=e.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?S+B:S):B=S,z){case 1:var $=-1;break;case 2:$=250;break;case 5:$=1073741823;break;case 4:$=1e4;break;default:$=5e3}return $=B+$,z={id:x++,callback:D,priorityLevel:z,startTime:B,expirationTime:$,sortIndex:-1},B>S?(z.sortIndex=B,t(d,z),r(u)===null&&z===r(d)&&(j?(f(P),P=-1):j=!0,He(w,B-S))):(z.sortIndex=$,t(u,z),g||v||(g=!0,qe(b))),z},e.unstable_shouldYield=m,e.unstable_wrapCallback=function(z){var D=p;return function(){var B=p;p=D;try{return z.apply(this,arguments)}finally{p=B}}}})(zu);_u.exports=zu;var kp=_u.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wm=A.forwardRef(({color:e="currentColor",size:t=24,strokeWidth:r=2,absoluteStrokeWidth:n,className:i="",children:s,iconNode:a,...l},u)=>A.createElement("svg",{ref:u,...km,width:t,height:t,stroke:e,strokeWidth:n?Number(r)*24/Number(t):r,className:$d("lucide",i),...l},[...a.map(([d,x])=>A.createElement(d,x)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L=(e,t)=>{const r=A.forwardRef(({className:n,...i},s)=>A.createElement(wm,{ref:s,iconNode:t,className:$d(`lucide-${xm(e)}`,n),...i}));return r.displayName=`${e}`,r};/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ud=L("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jm=L("Award",[["path",{d:"m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526",key:"1yiouv"}],["circle",{cx:"12",cy:"8",r:"6",key:"1vp47v"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ba=L("Bell",[["path",{d:"M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9",key:"1qo2s2"}],["path",{d:"M10.3 21a1.94 1.94 0 0 0 3.4 0",key:"qgo35s"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ls=L("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ms=L("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Os=L("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vd=L("CircleAlert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Di=L("CircleCheckBig",[["path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14",key:"g774vq"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $a=L("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Cm=L("CirclePlus",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M8 12h8",key:"1wcyev"}],["path",{d:"M12 8v8",key:"napkw2"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bm=L("Coffee",[["path",{d:"M10 2v2",key:"7u0qdc"}],["path",{d:"M14 2v2",key:"6buw04"}],["path",{d:"M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1",key:"pwadti"}],["path",{d:"M6 2v2",key:"colzsn"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Nm=L("Cookie",[["path",{d:"M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5",key:"laymnq"}],["path",{d:"M8.5 8.5v.01",key:"ue8clq"}],["path",{d:"M16 15.5v.01",key:"14dtrp"}],["path",{d:"M12 12v.01",key:"u5ubse"}],["path",{d:"M11 17v.01",key:"1hyl5a"}],["path",{d:"M7 14v.01",key:"uct60s"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Em=L("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _m=L("CupSoda",[["path",{d:"m6 8 1.75 12.28a2 2 0 0 0 2 1.72h4.54a2 2 0 0 0 2-1.72L18 8",key:"8166m8"}],["path",{d:"M5 8h14",key:"pcz4l3"}],["path",{d:"M7 15a6.47 6.47 0 0 1 5 0 6.47 6.47 0 0 0 5 0",key:"yjz344"}],["path",{d:"m12 8 1-6h2",key:"3ybfa4"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qd=L("DollarSign",[["line",{x1:"12",x2:"12",y1:"2",y2:"22",key:"7eqyqh"}],["path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6",key:"1b0p4s"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zm=L("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pm=L("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hd=L("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const su=L("FolderPlus",[["path",{d:"M12 10v6",key:"1bos4e"}],["path",{d:"M9 13h6",key:"1uhe8q"}],["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ds=L("History",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M12 7v5l4 2",key:"1fdv2h"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tm=L("Key",[["path",{d:"m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4",key:"g0fldk"}],["path",{d:"m21 2-9.6 9.6",key:"1j0ho8"}],["circle",{cx:"7.5",cy:"15.5",r:"5.5",key:"yqb3hr"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const au=L("Lock",[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Am=L("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Rm=L("MessageSquare",[["path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",key:"1lielz"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Lm=L("Minus",[["path",{d:"M5 12h14",key:"1ays0h"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lu=L("Moon",[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z",key:"a7tn18"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wd=L("PackageCheck",[["path",{d:"m16 16 2 2 4-4",key:"gfu2re"}],["path",{d:"M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14",key:"e7tb2h"}],["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}],["polyline",{points:"3.29 7 12 12 20.71 7",key:"ousv84"}],["line",{x1:"12",x2:"12",y1:"22",y2:"12",key:"a4e8g8"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mm=L("Pen",[["path",{d:"M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z",key:"5qss01"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Is=L("Phone",[["path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z",key:"foiqr5"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dm=L("Play",[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fs=L("Plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uu=L("QrCode",[["rect",{width:"5",height:"5",x:"3",y:"3",rx:"1",key:"1tu5fj"}],["rect",{width:"5",height:"5",x:"16",y:"3",rx:"1",key:"1v8r4q"}],["rect",{width:"5",height:"5",x:"3",y:"16",rx:"1",key:"1x03jg"}],["path",{d:"M21 16h-3a2 2 0 0 0-2 2v3",key:"177gqh"}],["path",{d:"M21 21v.01",key:"ents32"}],["path",{d:"M12 7v3a2 2 0 0 1-2 2H7",key:"8crl2c"}],["path",{d:"M3 12h.01",key:"nlz23k"}],["path",{d:"M12 3h.01",key:"n36tog"}],["path",{d:"M12 16v.01",key:"133mhm"}],["path",{d:"M16 12h1",key:"1slzba"}],["path",{d:"M21 12v.01",key:"1lwtk9"}],["path",{d:"M12 21v-1",key:"1880an"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ua=L("Search",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cu=L("Send",[["path",{d:"m22 2-7 20-4-9-9-4Z",key:"1q3vgg"}],["path",{d:"M22 2 11 13",key:"nzbqef"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Va=L("ShieldAlert",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"M12 8v4",key:"1got3b"}],["path",{d:"M12 16h.01",key:"1drbdi"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fm=L("SquarePen",[["path",{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",key:"1m0v6g"}],["path",{d:"M18.375 2.625a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4Z",key:"1lpok0"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kd=L("Square",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const du=L("Sun",[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xd=L("Tag",[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $m=L("ToggleRight",[["rect",{width:"20",height:"12",x:"2",y:"6",rx:"6",ry:"6",key:"f2vt7d"}],["circle",{cx:"16",cy:"12",r:"2",key:"4ma0v8"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ii=L("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Um=L("TrendingUp",[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vm=L("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fi=L("Tv",[["rect",{width:"20",height:"15",x:"2",y:"7",rx:"2",ry:"2",key:"10ag99"}],["polyline",{points:"17 2 12 7 7 2",key:"11pgbg"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pu=L("UserCheck",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["polyline",{points:"16 11 18 13 22 9",key:"1pwet4"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qm=L("UserPlus",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["line",{x1:"19",x2:"19",y1:"8",y2:"14",key:"1bvyxn"}],["line",{x1:"22",x2:"16",y1:"11",y2:"11",key:"1shjgl"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _r=L("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hm=L("Volume2",[["polygon",{points:"11 5 6 9 2 9 2 15 6 15 11 19 11 5",key:"16drj5"}],["path",{d:"M15.54 8.46a5 5 0 0 1 0 7.07",key:"ltjumu"}],["path",{d:"M19.07 4.93a10 10 0 0 1 0 14.14",key:"1kegas"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wm=L("VolumeX",[["polygon",{points:"11 5 6 9 2 9 2 15 6 15 11 19 11 5",key:"16drj5"}],["line",{x1:"22",x2:"16",y1:"9",y2:"15",key:"1ewh16"}],["line",{x1:"16",x2:"22",y1:"9",y2:"15",key:"5ykzw1"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qm=L("WifiOff",[["path",{d:"M12 20h.01",key:"zekei9"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0",key:"1bycff"}],["path",{d:"M5 12.859a10 10 0 0 1 5.17-2.69",key:"1dl1wf"}],["path",{d:"M19 12.859a10 10 0 0 0-2.007-1.523",key:"4k23kn"}],["path",{d:"M2 8.82a15 15 0 0 1 4.177-2.643",key:"1grhjp"}],["path",{d:"M22 8.82a15 15 0 0 0-11.288-3.764",key:"z3jwby"}],["path",{d:"m2 2 20 20",key:"1ooewy"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Km=L("Wifi",[["path",{d:"M12 20h.01",key:"zekei9"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0",key:"dnpr2z"}],["path",{d:"M5 12.859a10 10 0 0 1 14 0",key:"1x1e6c"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0",key:"1bycff"}]]);/**
 * @license lucide-react v0.380.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xm=L("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function Ym({chave:e,nome:t,cidade:r,valor:n,txtId:i="***"}){if(!e)return"";const s=String(e).trim(),a=String(t||"Festa do Morango").trim().normalize("NFD").replace(/[\u0300-\u036f]/g,"").substring(0,25),l=String(r||"SAO PAULO").trim().normalize("NFD").replace(/[\u0300-\u036f]/g,"").substring(0,15).toUpperCase(),u=Number(n||0).toFixed(2);function d(P,U){const I=U.length.toString().padStart(2,"0");return`${P}${I}${U}`}const x=d("00","br.gov.bcb.pix"),y=d("01",s),p=d("26",`${x}${y}`),v=d("52","0000"),g=d("53","986"),j=d("54",u),N=d("58","BR"),f=d("59",a),c=d("60",l),h=d("05",i||"***"),w=d("62",h),b=`000201${p}${v}${g}${j}${N}${f}${c}${w}6304`;let _=65535;for(let P=0;P<b.length;P++){_^=b.charCodeAt(P)<<8;for(let U=0;U<8;U++)_&32768?_=(_<<1^4129)&65535:_=_<<1&65535}const E=(_&65535).toString(16).toUpperCase().padStart(4,"0");return`${b}${E}`}function Gm({socket:e,menu:t,operador:r,onEnviarPedido:n}){const[i,s]=A.useState(""),[a,l]=A.useState([]),[u,d]=A.useState("todas"),[x,y]=A.useState(null),[p,v]=A.useState("cardapio"),[g,j]=A.useState("pix"),[N,f]=A.useState(""),[c,h]=A.useState(()=>{const k=new Date;return k.setDate(k.getDate()+7),k.toISOString().split("T")[0]}),[w,b]=A.useState(null),[_,E]=A.useState(!1),[P,U]=A.useState(!1);A.useEffect(()=>{fetch("/api/pix-config").then(k=>k.json()).then(k=>b(k)).catch(k=>console.error("Erro ao carregar chave PIX:",k))},[]);const I=Array.isArray(t)?t:t&&Array.isArray(t.produtos)?t.produtos:[],m=t&&Array.isArray(t.categorias)?t.categorias:[],O=k=>{if(k.categoria)return k.categoria;const T=m.find(V=>V.id===k.categoriaId);return T?T.nome:"Geral"},W=["todas",...new Set(I.map(k=>O(k)))],F=k=>{l(T=>T.find(M=>M.id===k.id)?T.map(M=>M.id===k.id?{...M,quantidade:M.quantidade+1}:M):[...T,{...k,quantidade:1,observacao:""}])},ke=(k,T)=>{l(V=>V.map(M=>{if(M.id===k){const me=M.quantidade+T;return me>0?{...M,quantidade:me}:null}return M}).filter(Boolean))},qe=(k,T)=>{l(V=>V.map(M=>M.id===k?{...M,observacao:T}:M))},He=k=>{l(T=>T.filter(V=>V.id!==k))},z=a.reduce((k,T)=>k+T.preco*T.quantidade,0),D=a.reduce((k,T)=>k+T.quantidade,0),B=w!=null&&w.chavePix?Ym({chave:w.chavePix,nome:w.nomeBeneficiario,cidade:w.cidadeBeneficiario,valor:z}):"",S=()=>{B&&(navigator.clipboard.writeText(B),U(!0),setTimeout(()=>U(!1),3e3))},$=k=>{if(k&&k.preventDefault(),!i.trim()){alert("Por favor, informe o NOME DO CLIENTE.");return}if(a.length===0){alert("O carrinho está vazio! Adicione pelo menos um item.");return}if(g==="pagar_depois"){if(!N.trim()){alert('Para a opção "Pagar Depois", é OBRIGATÓRIO informar o TELEFONE / WHATSAPP do cliente!');return}if(!c){alert('Para a opção "Pagar Depois", é OBRIGATÓRIO informar a DATA DE COBRANÇA!');return}}const T={cliente:i.trim(),criadoPor:r?r.nome:"Caixa",itens:a.map(M=>({id:M.id,nome:M.nome,preco:M.preco,quantidade:M.quantidade,observacao:M.observacao||""})),total:z,formaPagamento:g,telefoneCliente:g==="pagar_depois"?N.trim():N.trim()||void 0,dataCobranca:g==="pagar_depois"?c:void 0},V=n||(e?(M,me)=>e.emit("criar_pedido",M,me):null);V?V(T,M=>{var at,_n;const me=((at=M==null?void 0:M.order)==null?void 0:at.numero)||((_n=M==null?void 0:M.pedido)==null?void 0:_n.numero)||"OK";y(`Pedido #${me} enviado para a cozinha!`),E(!1),s(""),f(""),l([]),j("pix"),v("cardapio"),setTimeout(()=>y(null),4e3)}):fetch("/api/orders",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(T)}).then(M=>M.json()).then(M=>{M&&M.order&&(y(`Pedido #${M.order.numero} enviado para a cozinha!`),E(!1),s(""),f(""),l([]),j("pix"),v("cardapio"),setTimeout(()=>y(null),4e3))}).catch(M=>{console.error("Erro ao enviar pedido:",M),alert("Erro ao comunicar com o servidor.")})},ne=I.filter(k=>{const T=k.disponivel!==!1&&k.ativo!==!1,V=O(k),M=u==="todas"||V===u||k.categoriaId===u;return T&&M});return o.jsxs("div",{className:"caixa-container",children:[o.jsx("style",{children:`
        .caixa-container {
          display: grid;
      ...
      `}),o.jsxs("div",{className:"mobile-view-toggle",children:[o.jsxs("button",{className:`mobile-toggle-btn ${p==="cardapio"?"active":""}`,onClick:()=>v("cardapio"),children:[o.jsx(Xd,{size:16})," Cardápio de Produtos"]}),o.jsxs("button",{className:`mobile-toggle-btn ${p==="carrinho"?"active":""}`,onClick:()=>v("carrinho"),children:[o.jsx(ct,{size:16})," Comanda (",D,")"]})]}),o.jsxs("div",{className:`caixa-cardapio-col ${p!=="cardapio"?"mobile-hidden":""}`,children:[o.jsxs("div",{className:"view-title",style:{margin:0},children:[o.jsx(ct,{size:24,color:"var(--primary)"}),o.jsx("span",{children:"Cardápio - Lançar Pedidos"})]}),x&&o.jsxs("div",{style:{background:"var(--color-primary-bg)",border:"1px solid var(--color-primary)",color:"var(--color-primary)",padding:"0.75rem 1rem",borderRadius:"var(--radius-md)",display:"flex",alignItems:"center",gap:"0.5rem",fontWeight:600},children:[o.jsx($a,{size:18}),o.jsx("span",{children:x})]}),o.jsx("div",{className:"cat-pills",children:W.map(k=>o.jsx("button",{className:`cat-btn ${u===k?"active":""}`,onClick:()=>d(k),children:k==="todas"?"Todas as Categorias":k},k))}),o.jsx("div",{className:"produtos-grid",children:ne.map(k=>o.jsxs("div",{className:"prod-card",onClick:()=>F(k),children:[o.jsxs("div",{children:[o.jsx("span",{className:"prod-cat",children:O(k)}),o.jsx("div",{className:"prod-title",children:k.nome}),k.descricao&&o.jsx("div",{className:"prod-desc",children:k.descricao})]}),o.jsxs("div",{className:"prod-footer",children:[o.jsxs("span",{className:"prod-preco",children:["R$ ",(k.preco||0).toFixed(2)]}),o.jsx("button",{className:"prod-add-btn",title:"Adicionar ao Pedido",children:o.jsx(Fs,{size:18})})]})]},k.id))})]}),o.jsxs("div",{className:`caixa-carrinho-col ${p!=="carrinho"?"mobile-hidden":""}`,children:[o.jsxs("div",{className:"carrinho-header",children:[o.jsxs("div",{className:"carrinho-title",children:[o.jsx(ct,{size:20,color:"var(--primary)"}),o.jsx("span",{children:"Comanda Atual"})]}),a.length>0&&o.jsx("button",{className:"btn btn-secondary",style:{padding:"0.3rem 0.6rem",fontSize:"0.8rem",minHeight:"32px"},onClick:()=>l([]),children:"Limpar"})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{className:"form-label",children:"Nome do Cliente *"}),o.jsxs("div",{className:"cliente-input-box",children:[o.jsx(_r,{size:18,color:"var(--primary)"}),o.jsx("input",{type:"text",className:"cliente-input",placeholder:"Digite o nome do cliente...",value:i,onChange:k=>s(k.target.value)})]})]}),o.jsx("div",{className:"carrinho-itens",children:a.length===0?o.jsxs("div",{className:"carrinho-vazio",children:[o.jsx(ct,{size:36,opacity:.4}),o.jsx("p",{children:"Nenhum item adicionado ainda."}),o.jsx("span",{style:{fontSize:"0.82rem"},children:"Clique nos produtos do cardápio para montar o pedido."})]}):a.map(k=>o.jsxs("div",{className:"carrinho-item",children:[o.jsxs("div",{className:"item-main",children:[o.jsxs("div",{children:[o.jsx("div",{className:"item-nome",children:k.nome}),o.jsxs("div",{className:"item-preco",children:["R$ ",(k.preco*k.quantidade).toFixed(2)]})]}),o.jsxs("div",{className:"item-qtd-ctrl",children:[o.jsx("button",{className:"qtd-btn",onClick:()=>ke(k.id,-1),children:o.jsx(Lm,{size:14})}),o.jsx("span",{className:"qtd-val",children:k.quantidade}),o.jsx("button",{className:"qtd-btn",onClick:()=>ke(k.id,1),children:o.jsx(Fs,{size:14})}),o.jsx("button",{className:"qtd-btn",style:{color:"var(--primary)",marginLeft:"4px"},onClick:()=>He(k.id),children:o.jsx(Ii,{size:14})})]})]}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.3rem"},children:[o.jsx(Hd,{size:12,color:"var(--app-ink-muted)"}),o.jsx("input",{type:"text",className:"obs-input",placeholder:"Obs (ex: Sem maionese)...",value:k.observacao,onChange:T=>qe(k.id,T.target.value)})]})]},k.id))}),o.jsxs("div",{style:{borderTop:"1px solid var(--app-border)",paddingTop:"0.75rem",display:"flex",flexDirection:"column",gap:"0.6rem"},children:[o.jsx("label",{className:"form-label",children:"Forma de Pagamento *"}),o.jsxs("div",{className:"pgto-grid",children:[o.jsxs("button",{type:"button",className:`pgto-btn ${g==="pix"?"active":""}`,onClick:()=>j("pix"),children:[o.jsx(pi,{size:16})," PIX"]}),o.jsxs("button",{type:"button",className:`pgto-btn ${g==="dinheiro"?"active":""}`,onClick:()=>j("dinheiro"),children:[o.jsx(qd,{size:16})," Dinheiro"]}),o.jsxs("button",{type:"button",className:`pgto-btn ${g==="debito"?"active":""}`,onClick:()=>j("debito"),children:[o.jsx(pi,{size:16})," Débito"]}),o.jsxs("button",{type:"button",className:`pgto-btn ${g==="credito"?"active":""}`,onClick:()=>j("credito"),children:[o.jsx(pi,{size:16})," Crédito"]}),o.jsxs("button",{type:"button",className:`pgto-btn pagar-depois ${g==="pagar_depois"?"active pagar-depois":""}`,style:{gridColumn:"span 2"},onClick:()=>j("pagar_depois"),children:[o.jsx(Ls,{size:16})," Pagar Depois (Fiado)"]})]}),g==="pix"&&z>0&&o.jsxs("button",{type:"button",className:"btn btn-secondary",style:{marginTop:"0.3rem",border:"1px solid var(--primary)",color:"var(--primary)",fontWeight:700},onClick:()=>E(!0),children:[o.jsx(uu,{size:18})," Gerar QR Code PIX (R$ ",z.toFixed(2),")"]}),g==="pagar_depois"&&o.jsxs("div",{style:{background:"rgba(230, 134, 25, 0.12)",border:"1px solid var(--status-preparo)",borderRadius:"var(--radius-md)",padding:"0.85rem",display:"flex",flexDirection:"column",gap:"0.75rem",marginTop:"0.3rem"},children:[o.jsxs("div",{className:"form-group",children:[o.jsxs("label",{className:"form-label",style:{color:"var(--status-preparo)",display:"flex",alignItems:"center",gap:"0.3rem"},children:[o.jsx(Is,{size:14})," Telefone / WhatsApp do Cliente *"]}),o.jsx("input",{type:"tel",className:"form-input",placeholder:"Ex: (11) 98765-4321",value:N,onChange:k=>f(k.target.value),style:{borderColor:"var(--status-preparo)",background:"var(--app-canvas)"},required:!0})]}),o.jsxs("div",{className:"form-group",children:[o.jsxs("label",{className:"form-label",style:{color:"var(--status-preparo)",display:"flex",alignItems:"center",gap:"0.3rem"},children:[o.jsx(io,{size:14})," Data de Cobrança / Vencimento *"]}),o.jsx("input",{type:"date",className:"form-input",value:c,onChange:k=>h(k.target.value),style:{borderColor:"var(--status-preparo)",background:"var(--app-canvas)"},required:!0})]}),o.jsxs("div",{style:{fontSize:"0.78rem",color:"var(--app-ink-muted)",display:"flex",alignItems:"center",gap:"0.3rem"},children:[o.jsx(Vd,{size:13,color:"var(--status-preparo)"}),o.jsx("span",{children:"O telefone e a data são obrigatórios para controle de fiado."})]})]})]}),o.jsxs("div",{className:"carrinho-footer",children:[o.jsxs("div",{className:"total-row",children:[o.jsx("span",{className:"total-label",children:"Total a Pagar:"}),o.jsxs("span",{className:"total-value",children:["R$ ",z.toFixed(2)]})]}),o.jsxs("button",{className:"btn btn-primary btn-enviar",onClick:$,disabled:a.length===0||!i.trim(),children:[o.jsx(cu,{size:18})," Enviar para Cozinha"]})]})]}),_&&o.jsx("div",{className:"modal-overlay",children:o.jsxs("div",{className:"modal-card-pix",children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",width:"100%",alignItems:"center"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.4rem",fontWeight:700,fontSize:"1.1rem",color:"var(--text-title)"},children:[o.jsx(uu,{size:22,color:"var(--primary)"})," Pagamento via PIX"]}),o.jsx("button",{className:"btn btn-secondary",style:{padding:"0.2rem 0.5rem",minHeight:"30px"},onClick:()=>E(!1),children:o.jsx(Xm,{size:16})})]}),o.jsxs("div",{style:{fontSize:"0.9rem",color:"var(--app-ink-muted)"},children:["Cliente: ",o.jsx("strong",{style:{color:"var(--text-title)"},children:i||"Cliente no Caixa"})]}),B?o.jsx("div",{style:{background:"#FFFFFF",padding:"1rem",borderRadius:"var(--radius-md)",border:"2px solid var(--primary)",display:"flex",flexDirection:"column",alignItems:"center"},children:o.jsx("img",{src:`https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent(B)}`,alt:"QR Code PIX Dinâmico",style:{width:"200px",height:"200px"}})}):o.jsx("div",{style:{padding:"1rem",color:"var(--status-urgente)",fontSize:"0.85rem"},children:"Nenhuma Chave PIX cadastrada pelo Administrador."}),o.jsxs("div",{style:{fontSize:"1.6rem",fontWeight:800,color:"var(--color-primary)"},children:["R$ ",z.toFixed(2)]}),o.jsxs("div",{style:{fontSize:"0.82rem",color:"var(--app-ink-muted)"},children:["Beneficiário: ",o.jsx("strong",{children:(w==null?void 0:w.nomeBeneficiario)||"Festa do Morango"})," (",w==null?void 0:w.chavePix,")"]}),B&&o.jsx("div",{style:{width:"100%",display:"flex",flexDirection:"column",gap:"0.4rem"},children:o.jsxs("button",{className:"btn btn-secondary",style:{width:"100%",fontSize:"0.85rem"},onClick:S,children:[P?o.jsx(kr,{size:16,color:"var(--primary)"}):o.jsx(Em,{size:16}),P?"Código PIX Copiado!":"Copiar Código Pix Copia e Cola"]})}),o.jsxs("div",{style:{display:"flex",gap:"0.5rem",width:"100%",marginTop:"0.5rem"},children:[o.jsx("button",{className:"btn btn-secondary",style:{flex:1},onClick:()=>E(!1),children:"Voltar"}),o.jsxs("button",{className:"btn btn-primary",style:{flex:1.5},onClick:$,disabled:a.length===0||!i.trim(),children:[o.jsx(cu,{size:16})," Confirmar & Enviar"]})]})]})}),o.jsxs("div",{className:`mobile-cart-float-bar ${p==="cardapio"&&a.length>0?"mobile-show-float":""}`,onClick:()=>v("carrinho"),children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.6rem"},children:[o.jsx(ct,{size:20}),o.jsxs("span",{children:["Ver Pedido (",D," ",D===1?"item":"itens",")"]})]}),o.jsxs("span",{children:["R$ ",z.toFixed(2)," →"]})]})]})}function Jm({pedidos:e,operador:t,onMudarStatus:r,onAlternarItemEntregue:n}){const[i,s]=A.useState(Date.now()),[a,l]=A.useState("ativos");A.useEffect(()=>{const v=setInterval(()=>{s(Date.now())},1e3);return()=>clearInterval(v)},[]);const u=e.filter(v=>v.status==="pendente"||v.status==="em_preparo"||v.status==="entrega_parcial"),d=u.filter(v=>a==="pendentes"?v.status==="pendente":a==="preparo"?v.status==="em_preparo":a==="parcial"?v.status==="entrega_parcial":a==="meus"&&t?v.preparadoPor&&v.preparadoPor.includes(t.nome):!0),x=v=>{const g=new Date(v).getTime(),j=i-g;return Math.floor(j/6e4)},y=v=>{const g=new Date(v).getTime(),j=Math.max(0,i-g),N=Math.floor(j/6e4),f=Math.floor(j%6e4/1e3);return`${String(N).padStart(2,"0")}:${String(f).padStart(2,"0")}`},p=v=>{const g=x(v);return g>=10?"urgente":g>=5?"alerta":"normal"};return o.jsxs("div",{className:"cozinha-container",children:[o.jsx("style",{children:`
        .cozinha-container {
          display: flex;
          flex-direction: column;
          gap: 1.25rem;
      ...
      `}),o.jsxs("div",{className:"tv-main-panel",children:[o.jsx("div",{className:"tv-panel-controls",children:o.jsxs("button",{className:`btn btn-secondary ${i?"":"muted"}`,style:{padding:"0.4rem 0.8rem"},onClick:()=>{s(!i),i||fu()},children:[i?o.jsx(Hm,{size:18,color:"var(--status-pronto)"}):o.jsx(Wm,{size:18,color:"var(--primary)"}),o.jsx("span",{style:{fontSize:"0.85rem"},children:i?"Som Ativo":"Mudo"})]})}),o.jsxs("div",{className:"destaque-label",children:[o.jsx(Ba,{size:22,color:"var(--status-pronto)"}),o.jsx("span",{children:"Pronto para Retirada no Balcão"})]}),y?o.jsxs("div",{className:"destaque-card",children:[o.jsxs("div",{className:"destaque-comanda",children:["#",y.numero]}),o.jsx("div",{className:"destaque-cliente",children:y.cliente}),y.itens&&o.jsxs("div",{className:"destaque-itens-box",children:[o.jsxs("div",{style:{fontSize:"0.8rem",fontWeight:700,color:"var(--app-ink-muted)",textTransform:"uppercase",letterSpacing:"0.5px",textAlign:"left",display:"flex",justifyContent:"space-between"},children:[o.jsx("span",{children:"Conferência de Itens no Balcão:"}),o.jsxs("span",{style:{color:"var(--primary)",fontWeight:800},children:[y.itens.filter(g=>g.entregue).length," de ",y.itens.length," entregues"]})]}),y.itens.map((g,j)=>{const N=!!g.entregue;return o.jsxs("div",{className:`destaque-item-row ${N?"item-entregue":""}`,onClick:()=>n&&n(y.id,j,!N),children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.55rem"},children:[o.jsxs("span",{className:N?"badge badge-pronto":"badge badge-pendente",children:[g.quantidade,"x"]}),o.jsx("span",{style:{color:N?"#156b16":"var(--text-title)",textDecoration:N?"line-through":"none",fontWeight:700},children:g.nome}),g.observacao&&o.jsxs("span",{style:{fontSize:"0.78rem",color:"var(--text-obs)"},children:["(",g.observacao,")"]})]}),o.jsxs("button",{type:"button",className:`btn ${N?"btn-success":"btn-secondary"}`,style:{padding:"0.35rem 0.75rem",fontSize:"0.82rem",minHeight:"32px",fontWeight:700},onClick:f=>{f.stopPropagation(),n&&n(y.id,j,!N)},children:[N?o.jsx(Qd,{size:16}):o.jsx(Kd,{size:16}),o.jsx("span",{children:N?"✓ Entregue":"Dar Baixa"})]})]},j)})]}),o.jsxs("div",{className:"destaque-acoes",children:[o.jsxs("button",{className:"btn btn-success",style:{flex:2,padding:"0.85rem",fontSize:"1rem",borderRadius:"var(--radius-md)",fontWeight:700},onClick:()=>v(y.id),children:[o.jsx(pu,{size:20})," Finalizar & Entregar Todos"]}),u.length>1&&o.jsxs("button",{className:"btn btn-secondary",style:{flex:1,padding:"0.85rem",fontSize:"0.88rem",borderRadius:"var(--radius-md)",fontWeight:600},onClick:p,children:[o.jsx(Ud,{size:18})," Próximo da Fila"]})]})]}):o.jsxs("div",{className:"chamada-vazio",children:[o.jsx(Fi,{size:64,strokeWidth:1.5,color:"var(--app-ink-muted)"}),o.jsx("h2",{style:{color:"var(--text-title)"},children:"Aguardando Próximo Pedido..."}),o.jsx("p",{children:"Os nomes dos clientes aparecerão aqui assim que a cozinha marcar o pedido como pronto."})]})]}),o.jsxs("div",{className:"tv-sidebar",children:[o.jsxs("div",{className:"sidebar-section",children:[o.jsxs("div",{className:"sidebar-title",children:[o.jsx(Di,{size:18,color:"var(--status-pronto)"}),o.jsxs("span",{children:["Fila no Balcão (",u.length,")"]})]}),o.jsx("div",{className:"prontos-lista",children:u.length===0?o.jsx("span",{style:{fontSize:"0.85rem",color:"var(--app-ink-muted)",textAlign:"center",padding:"1rem 0"},children:"Nenhum outro pedido pronto no momento."}):u.map(g=>{const j=y&&g.id===y.id;return o.jsxs("div",{className:`pronto-item ${j?"item-ativo-tv":""}`,onClick:()=>l(g.id),children:[o.jsxs("div",{children:[o.jsxs("strong",{style:{fontSize:"1.1rem",color:"var(--text-title)"},children:["#",g.numero]}),o.jsx("div",{style:{color:"var(--status-pronto)",fontWeight:700,fontSize:"0.95rem"},children:g.cliente}),g.status==="entrega_parcial"&&o.jsxs("span",{className:"badge badge-entregue",style:{fontSize:"0.7rem",marginTop:"0.2rem"},children:["PARCIAL (",g.itens?g.itens.filter(N=>N.entregue).length:0,"/",g.itens?g.itens.length:0,")"]})]}),o.jsxs("div",{style:{display:"flex",gap:"0.3rem"},children:[o.jsx("button",{type:"button",className:"btn btn-secondary",style:{padding:"0.35rem 0.55rem",fontSize:"0.78rem"},onClick:N=>{N.stopPropagation(),l(g.id)},children:j?"Exibindo":"Exibir"}),o.jsx("button",{type:"button",className:"btn btn-success",style:{padding:"0.35rem 0.55rem",fontSize:"0.78rem"},onClick:N=>{N.stopPropagation(),v(g.id)},children:"Entregar"})]})]},g.id)})})]}),o.jsxs("div",{className:"sidebar-section",children:[o.jsxs("div",{className:"sidebar-title",children:[o.jsx(pu,{size:18,color:"var(--app-ink-muted)"}),o.jsx("span",{children:"Últimos Entregues"})]}),o.jsx("div",{className:"entregues-lista",children:d.length===0?o.jsx("span",{style:{fontSize:"0.85rem",color:"var(--app-ink-muted)"},children:"Nenhum pedido entregue ainda."}):d.map(g=>o.jsxs("div",{className:"entregue-chip",children:[o.jsxs("span",{children:["#",g.numero]}),o.jsx("strong",{style:{color:"var(--app-ink)"},children:g.cliente})]},g.id))})]})]})]})}const Yd=[{id:"burger",nome:"Hambúrguer",component:o.jsx(Sm,{size:18})},{id:"fries",nome:"Porção",component:o.jsx(Im,{size:18})},{id:"drink",nome:"Bebida",component:o.jsx(_m,{size:18})},{id:"dessert",nome:"Sobremesa",component:o.jsx(Nm,{size:18})},{id:"pizza",nome:"Pizza",component:o.jsx(Om,{size:18})},{id:"coffee",nome:"Café",component:o.jsx(bm,{size:18})},{id:"utensils",nome:"Geral",component:o.jsx(zr,{size:18})}];function hu(e){const t=Yd.find(r=>r.id===e);return t?t.component:o.jsx(zr,{size:16})}function tg({menu:e,onSalvarProduto:t,onExcluirProduto:r,onToggleDisponivel:n,onSalvarCategoria:i,onExcluirCategoria:s}){const[a,l]=A.useState("todas"),[u,d]=A.useState(""),[x,y]=A.useState(!1),[p,v]=A.useState(!1),[g,j]=A.useState(null),[N,f]=A.useState(""),[c,h]=A.useState(""),[w,b]=A.useState(""),[_,E]=A.useState(""),[P,U]=A.useState(""),[I,m]=A.useState("burger"),O=Array.isArray(e==null?void 0:e.categorias)?e.categorias:[],W=Array.isArray(e==null?void 0:e.produtos)?e.produtos:Array.isArray(e)?e:[],F=W.filter(S=>{const $=a==="todas"||S.categoriaId===a,ne=!u.trim()||S.nome.toLowerCase().includes(u.toLowerCase())||S.descricao&&S.descricao.toLowerCase().includes(u.toLowerCase());return $&&ne}),ke=(S=null)=>{var $;S?(j(S),f(S.nome),h(S.categoriaId),b(S.preco.toString()),E(S.descricao||"")):(j(null),f(""),h((($=O[0])==null?void 0:$.id)||"lanches"),b(""),E("")),y(!0)},qe=()=>{U(""),m("burger"),v(!0)},He=S=>{if(S.preventDefault(),!N.trim()||!w||!c){alert("Por favor, preencha todos os campos obrigatórios.");return}t({id:g?g.id:void 0,categoriaId:c,nome:N.trim(),preco:parseFloat(w),descricao:_.trim(),disponivel:g?g.disponivel:!0}),y(!1)},z=S=>{if(S.preventDefault(),!P.trim()){alert("O nome da categoria é obrigatório.");return}i({nome:P.trim(),icone:I}),v(!1)},D=S=>{window.confirm(`Tem certeza que deseja excluir o produto "${S.nome}"?`)&&r(S.id)},B=S=>{const $=W.filter(ne=>ne.categoriaId===S.id).length;if($>0){alert(`Não é possível excluir a categoria "${S.nome}" pois ela possui ${$} produto(s) vinculado(s).`);return}window.confirm(`Deseja excluir a categoria "${S.nome}"?`)&&s(S.id).then(ne=>{ne&&ne.error?alert(ne.error):a===S.id&&l("todas")})};return o.jsxs("div",{className:"cardapio-crud-container",children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("div",{className:"crud-topbar",children:[o.jsxs("div",{className:"view-title",style:{margin:0},children:[o.jsx(zr,{size:26,color:"var(--primary)"}),o.jsx("span",{children:"Gestão do Cardápio"})]}),o.jsxs("div",{className:"search-box",children:[o.jsx(Ua,{size:18,color:"var(--app-ink-muted)"}),o.jsx("input",{type:"text",className:"search-input",placeholder:"Buscar produto por nome...",value:u,onChange:S=>d(S.target.value)})]}),o.jsxs("div",{className:"crud-actions",children:[o.jsxs("button",{className:"btn btn-secondary",onClick:qe,children:[o.jsx(su,{size:18,color:"var(--status-preparo)"})," + Categoria"]}),o.jsxs("button",{className:"btn btn-primary",onClick:()=>ke(),children:[o.jsx(Fs,{size:18})," + Produto"]})]})]}),o.jsxs("div",{className:"cat-pills-bar",children:[o.jsxs("button",{className:`cat-pill-btn ${a==="todas"?"active":""}`,onClick:()=>l("todas"),children:[o.jsx(Xd,{size:14})," Todas (",W.length,")"]}),O.map(S=>{const $=W.filter(ne=>ne.categoriaId===S.id).length;return o.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[o.jsxs("button",{className:`cat-pill-btn ${a===S.id?"active":""}`,onClick:()=>l(S.id),children:[hu(S.icone)," ",o.jsx("span",{children:S.nome})," (",$,")"]}),$===0&&o.jsx("button",{title:"Excluir Categoria Vazia",style:{background:"none",border:"none",color:"var(--primary)",cursor:"pointer",padding:"0 0.3rem"},onClick:()=>B(S),children:o.jsx(Ii,{size:13})})]},S.id)})]}),o.jsx("div",{className:"crud-table-wrapper",children:o.jsxs("table",{className:"crud-table",children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{children:"Disponibilidade"}),o.jsx("th",{children:"Produto"}),o.jsx("th",{children:"Categoria"}),o.jsx("th",{children:"Preço"}),o.jsx("th",{children:"Descrição"}),o.jsx("th",{style:{textAlign:"right"},children:"Ações"})]})}),o.jsx("tbody",{children:F.length===0?o.jsx("tr",{children:o.jsxs("td",{colSpan:"6",style:{textAlign:"center",padding:"3rem 1rem",color:"var(--app-ink-muted)"},children:[o.jsx(Vd,{size:32,style:{marginBottom:"0.5rem",display:"block",margin:"0 auto"}}),"Nenhum produto encontrado. Clique em ",o.jsx("strong",{children:'"+ Produto"'})," para adicionar."]})}):F.map(S=>{const $=O.find(ne=>ne.id===S.categoriaId);return o.jsxs("tr",{children:[o.jsx("td",{children:o.jsx("button",{className:"btn btn-secondary",style:{padding:"0.35rem 0.7rem",fontSize:"0.8rem"},onClick:()=>n(S.id),children:S.disponivel?o.jsxs("span",{style:{color:"var(--status-pronto)",display:"flex",alignItems:"center",gap:"0.3rem",fontWeight:700},children:[o.jsx($m,{size:18})," Ativo"]}):o.jsxs("span",{style:{color:"var(--primary)",display:"flex",alignItems:"center",gap:"0.3rem",fontWeight:700},children:[o.jsx(Bm,{size:18})," Esgotado"]})})}),o.jsx("td",{children:o.jsx("strong",{style:{color:"var(--text-title)",fontSize:"1rem"},children:S.nome})}),o.jsx("td",{children:o.jsxs("span",{className:"badge badge-pendente",children:[hu($==null?void 0:$.icone)," ",($==null?void 0:$.nome)||S.categoriaId]})}),o.jsx("td",{children:o.jsxs("strong",{style:{color:"var(--status-pronto)",fontSize:"1.05rem"},children:["R$ ",S.preco.toFixed(2)]})}),o.jsx("td",{style:{fontSize:"0.85rem",color:"var(--app-ink-muted)",maxWidth:"280px"},children:S.descricao||"-"}),o.jsx("td",{children:o.jsxs("div",{className:"action-group",children:[o.jsxs("button",{className:"btn btn-secondary",style:{padding:"0.4rem 0.7rem",fontSize:"0.82rem"},onClick:()=>ke(S),children:[o.jsx(Mm,{size:14})," Editar"]}),o.jsxs("button",{className:"btn btn-secondary",style:{padding:"0.4rem 0.7rem",fontSize:"0.82rem",color:"var(--primary)"},onClick:()=>D(S),children:[o.jsx(Ii,{size:14})," Excluir"]})]})})]},S.id)})})]})}),x&&o.jsx("div",{className:"modal-backdrop",onClick:()=>y(!1),children:o.jsxs("div",{className:"modal-card",onClick:S=>S.stopPropagation(),children:[o.jsxs("div",{className:"modal-title",children:[o.jsx(zr,{size:20,color:"var(--primary)"}),o.jsx("span",{children:g?"Editar Produto":"Cadastrar Novo Produto"})]}),o.jsxs("form",{onSubmit:He,style:{display:"flex",flexDirection:"column",gap:"1rem"},children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{className:"form-label",children:"Nome do Produto *"}),o.jsx("input",{type:"text",className:"form-input",placeholder:"Ex: X-Salada Bacon Especial",value:N,onChange:S=>f(S.target.value),required:!0})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{className:"form-label",children:"Categoria *"}),o.jsx("select",{className:"form-input",value:c,onChange:S=>h(S.target.value),required:!0,children:O.map(S=>o.jsx("option",{value:S.id,children:S.nome},S.id))})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{className:"form-label",children:"Preço em R$ *"}),o.jsx("input",{type:"number",step:"0.10",className:"form-input",placeholder:"24.90",value:w,onChange:S=>b(S.target.value),required:!0})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{className:"form-label",children:"Descrição / Ingredientes"}),o.jsx("textarea",{className:"form-input",rows:"3",placeholder:"Ingredientes e detalhes (ex: Pão brioche, 160g hambúrguer, cheddar)...",value:_,onChange:S=>E(S.target.value)})]}),o.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:"0.75rem",marginTop:"0.5rem"},children:[o.jsx("button",{type:"button",className:"btn btn-secondary",onClick:()=>y(!1),children:"Cancelar"}),o.jsxs("button",{type:"submit",className:"btn btn-primary",children:[o.jsx(kr,{size:18})," Salvar Produto"]})]})]})]})}),p&&o.jsx("div",{className:"modal-backdrop",onClick:()=>v(!1),children:o.jsxs("div",{className:"modal-card",onClick:S=>S.stopPropagation(),children:[o.jsxs("div",{className:"modal-title",children:[o.jsx(su,{size:20,color:"var(--status-preparo)"}),o.jsx("span",{children:"Nova Categoria do Cardápio"})]}),o.jsxs("form",{onSubmit:z,style:{display:"flex",flexDirection:"column",gap:"1rem"},children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{className:"form-label",children:"Nome da Categoria *"}),o.jsx("input",{type:"text",className:"form-input",placeholder:"Ex: Combos Promocionais, Sobremesas...",value:P,onChange:S=>U(S.target.value),required:!0})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{className:"form-label",children:"Ícone da Categoria"}),o.jsx("div",{className:"icone-selector",children:Yd.map(S=>o.jsxs("button",{type:"button",className:`icone-opt ${I===S.id?"selected":""}`,onClick:()=>m(S.id),children:[S.component,o.jsx("span",{children:S.nome})]},S.id))})]}),o.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:"0.75rem",marginTop:"0.5rem"},children:[o.jsx("button",{type:"button",className:"btn btn-secondary",onClick:()=>v(!1),children:"Cancelar"}),o.jsxs("button",{type:"submit",className:"btn btn-success",children:[o.jsx(kr,{size:18})," Criar Categoria"]})]})]})]})})]})}function rg({pedidos:e,operador:t}){const[r,n]=A.useState(null),[i,s]=A.useState("hoje"),[a,l]=A.useState("todos"),[u,d]=A.useState(""),[x,y]=A.useState(""),[p,v]=A.useState("");if(!(t&&(t.role==="master"||t.role==="caixa")))return o.jsxs("div",{style:{background:"var(--app-surface-1)",border:"1px solid var(--app-border)",borderRadius:"var(--radius-lg)",padding:"3rem",textAlign:"center",color:"var(--app-ink-muted)"},children:[o.jsx(Va,{size:48,color:"var(--primary)",style:{marginBottom:"1rem"}}),o.jsx("h2",{style:{color:"var(--text-title)"},children:"Acesso Restrito ao Financeiro"}),o.jsx("p",{style:{marginTop:"0.5rem"},children:"Esta visão de faturamento é reservada apenas para Contas Master ou Caixa."})]});const j=m=>{n(O=>O===m?null:m)},N=(m,O)=>{m.stopPropagation(),window.confirm("Deseja confirmar a quitação/recebimento deste pedido pendente?")&&fetch(`/api/orders/${O}/pagamento`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({statusPagamento:"pago"})}).then(W=>W.json()).catch(W=>console.error("Erro ao quitar pagamento:",W))},f=m=>m.statusPagamento==="pago"?!1:m.statusPagamento==="pendente_pagamento"||m.formaPagamento==="pagar_depois",c=e.filter(m=>{if(u.trim()){const F=u.toLowerCase().trim(),ke=`#${m.numero}`.toLowerCase(),qe=(m.cliente||"").toLowerCase(),He=(m.telefoneCliente||"").toLowerCase();if(!(ke.includes(F)||qe.includes(F)||He.includes(F)))return!1}if(a==="pagos"&&f(m)||a==="fiado"&&!f(m)||a==="entregues"&&m.status!=="entregue"||a==="cancelados"&&m.status!=="cancelado"||a!=="cancelados"&&m.status==="cancelado")return!1;if(!m.criadoEm)return!0;const O=new Date(m.criadoEm),W=new Date;if(i==="hoje")return O.toDateString()===W.toDateString();if(i==="ontem"){const F=new Date;return F.setDate(W.getDate()-1),O.toDateString()===F.toDateString()}else if(i==="7dias"){const F=new Date;return F.setDate(W.getDate()-7),O>=F}else if(i==="custom"){if(x){const F=new Date(x);if(F.setHours(0,0,0,0),O<F)return!1}if(p){const F=new Date(p);if(F.setHours(23,59,59,999),O>F)return!1}}return!0}),h=c.filter(m=>m.status!=="cancelado"),w=h.filter(m=>!f(m)),b=h.filter(m=>f(m)),_=w.reduce((m,O)=>m+(Number(O.total)||0),0),E=b.reduce((m,O)=>m+(Number(O.total)||0),0),P=h.length,U=P>0?(_+E)/P:0,I=m=>{if(m.formaPagamento==="pagar_depois"||m.statusPagamento==="pendente_pagamento"){const O=m.dataCobranca?new Date(m.dataCobranca).toLocaleDateString():"Sem Data";return m.statusPagamento==="pago"?o.jsxs("span",{className:"badge badge-pronto",children:[o.jsx(kr,{size:12})," Pagar Depois (Quitado)"]}):o.jsxs("span",{className:"badge badge-preparo",children:[o.jsx(io,{size:12})," Pagar Depois (",O,")"]})}return o.jsxs("span",{className:"badge badge-pendente",children:[o.jsx(pi,{size:12})," ",m.formaPagamento?m.formaPagamento.toUpperCase():"PIX"]})};return o.jsxs("div",{className:"vendas-container",children:[o.jsx("style",{children:`
        .vendas-container {
          display: flex;
          flex-direction: column;
          gap: 1.25rem;
      ...
      `}),o.jsxs("div",{className:"logs-topbar",children:[o.jsxs("div",{className:"view-title",style:{margin:0},children:[o.jsx(Ds,{size:24,color:"var(--primary)"}),o.jsx("span",{children:"Logs de Auditoria"})]}),o.jsxs("div",{className:"search-box",children:[o.jsx(Ua,{size:16,color:"var(--app-ink-muted)"}),o.jsx("input",{type:"text",className:"search-input",placeholder:"Buscar comanda, cliente ou operador...",value:r,onChange:p=>n(p.target.value)})]})]}),o.jsxs("div",{className:"logs-pills-bar",children:[o.jsxs("button",{className:`cat-pill-btn ${i==="todas"?"active":""}`,onClick:()=>s("todas"),children:["Todos (",e.length,")"]}),o.jsxs("button",{className:`cat-pill-btn ${i==="criacao"?"active":""}`,onClick:()=>s("criacao"),children:["Criação (",e.filter(p=>p.acao==="criacao").length,")"]}),o.jsxs("button",{className:`cat-pill-btn ${i==="preparo"?"active":""}`,onClick:()=>s("preparo"),children:["Preparo (",e.filter(p=>p.acao==="preparo").length,")"]}),o.jsxs("button",{className:`cat-pill-btn ${i==="pronto"?"active":""}`,onClick:()=>s("pronto"),children:["Chamada (",e.filter(p=>p.acao==="pronto").length,")"]}),o.jsxs("button",{className:`cat-pill-btn ${i==="entregue"?"active":""}`,onClick:()=>s("entregue"),children:["Entregas (",e.filter(p=>p.acao==="entregue").length,")"]})]}),o.jsx("div",{className:"logs-table-wrapper",children:o.jsxs("table",{className:"logs-table",children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{children:"Horário"}),o.jsx("th",{children:"Operador"}),o.jsx("th",{children:"Ação"}),o.jsx("th",{children:"Comanda / Cliente"}),o.jsx("th",{children:"Descrição & Detalhes dos Itens / Valores"})]})}),o.jsx("tbody",{children:x.length===0?o.jsx("tr",{children:o.jsx("td",{colSpan:"5",style:{textAlign:"center",padding:"2rem 1rem",color:"var(--app-ink-muted)"},children:"Nenhum registro encontrado."})}):x.map(p=>{const v=new Date(p.timestamp),g=`${v.toLocaleDateString()} ${v.toLocaleTimeString()}`;return o.jsxs("tr",{children:[o.jsx("td",{children:o.jsxs("div",{className:"log-time",style:{display:"flex",alignItems:"center",gap:"0.3rem"},children:[o.jsx(io,{size:13}),o.jsx("span",{children:g})]})}),o.jsx("td",{children:o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.4rem",fontWeight:600,color:"var(--text-title)",whiteSpace:"nowrap"},children:[o.jsx(_r,{size:14,color:"var(--primary)"}),o.jsx("span",{children:p.usuario})]})}),o.jsx("td",{children:y(p.acao)}),o.jsxs("td",{children:[o.jsxs("strong",{style:{color:"var(--primary)"},children:["#",p.numeroPedido]}),o.jsxs("span",{style:{fontSize:"0.85rem",color:"var(--app-ink-muted)",marginLeft:"6px"},children:["(",p.cliente,")"]})]}),o.jsxs("td",{children:[o.jsx("div",{style:{fontSize:"0.88rem",color:"var(--app-ink)",fontWeight:600},children:p.descricao}),p.itens&&Array.isArray(p.itens)&&p.itens.length>0&&o.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"0.3rem",marginTop:"0.4rem"},children:p.itens.map((j,N)=>o.jsxs("div",{className:"item-chip",children:[o.jsx(Wd,{size:12,color:"var(--status-pronto)"}),o.jsxs("strong",{style:{color:"var(--primary)"},children:[j.quantidade,"x"]}),o.jsx("span",{children:j.nome}),o.jsxs("span",{style:{color:"var(--status-pronto)",fontWeight:600},children:["(R$ ",(j.preco*j.quantidade).toFixed(2),")"]}),j.observacao&&o.jsxs("span",{style:{color:"var(--text-obs)",fontSize:"0.75rem"},children:["[",j.observacao,"]"]})]},N))})]})]},p.id)})})]})}),o.jsx("div",{className:"logs-mobile-list",children:x.length===0?o.jsx("div",{style:{background:"var(--app-surface-1)",padding:"2rem",textAlign:"center",color:"var(--app-ink-muted)",borderRadius:"var(--radius-md)",border:"1px solid var(--app-border)"},children:"Nenhum log encontrado."}):x.map(p=>{const v=new Date(p.timestamp),g=v.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),j=a===p.id;return o.jsxs("div",{className:"log-card-mobile",onClick:()=>d(p.id),children:[o.jsxs("div",{className:"log-card-summary",children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.4rem"},children:[o.jsxs("strong",{style:{color:"var(--primary)",fontSize:"0.95rem"},children:["#",p.numeroPedido]}),o.jsx("span",{style:{fontWeight:600,color:"var(--text-title)",fontSize:"0.9rem"},children:p.cliente})]}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem"},children:[y(p.acao),o.jsx("span",{className:"log-time",style:{fontSize:"0.78rem"},children:g}),j?o.jsx(Os,{size:16,color:"var(--app-ink-muted)"}):o.jsx(Ms,{size:16,color:"var(--app-ink-muted)"})]})]}),j&&o.jsxs("div",{className:"log-card-details",children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.3rem",fontSize:"0.82rem",color:"var(--app-ink-muted)"},children:[o.jsx(_r,{size:13,color:"var(--primary)"}),o.jsxs("span",{children:["Operador: ",o.jsx("strong",{children:p.usuario})]}),o.jsxs("span",{style:{marginLeft:"auto"},children:[v.toLocaleDateString()," ",v.toLocaleTimeString()]})]}),o.jsx("div",{style:{fontSize:"0.85rem",color:"var(--app-ink)",fontWeight:600,marginTop:"0.2rem"},children:p.descricao}),p.itens&&Array.isArray(p.itens)&&p.itens.length>0&&o.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"0.3rem",marginTop:"0.3rem"},children:p.itens.map((N,f)=>o.jsxs("div",{className:"item-chip",style:{fontSize:"0.78rem"},children:[o.jsxs("strong",{style:{color:"var(--primary)"},children:[N.quantidade,"x"]})," ",N.nome," (R$ ",(N.preco*N.quantidade).toFixed(2),")",N.observacao&&o.jsxs("span",{style:{color:"var(--text-obs)"},children:["[",N.observacao,"]"]})]},f))})]})]},p.id)})})]})}const ie=di(window.location.origin,{transports:["websocket","polling"]});function og(){const[e,t]=A.useState("caixa"),[r,n]=A.useState(!1),[i,s]=A.useState(()=>localStorage.getItem("tema_lanchonete")||"claro");A.useEffect(()=>{document.documentElement.setAttribute("data-theme",i),document.body.setAttribute("data-theme",i)},[i]);const[a,l]=A.useState(()=>{try{const k=localStorage.getItem("operador_lanchonete");return k?JSON.parse(k):null}catch{return null}}),[u,d]=A.useState(""),[x,y]=A.useState(""),[p,v]=A.useState(null),[g,j]=A.useState(!1),[N,f]=A.useState([]),[c,h]=A.useState({categorias:[],produtos:[]}),[w,b]=A.useState([]),[_,E]=A.useState(null),P=k=>k?Array.isArray(k)?{categorias:[],produtos:k}:{categorias:Array.isArray(k.categorias)?k.categorias:[],produtos:Array.isArray(k.produtos)?k.produtos:[]}:{categorias:[],produtos:[]};A.useEffect(()=>{fetch("/api/menu").then(k=>k.json()).then(k=>h(P(k))).catch(k=>console.error("Erro ao carregar cardápio via REST:",k)),fetch("/api/logs").then(k=>k.json()).then(k=>b(k)).catch(k=>console.error("Erro ao buscar logs:",k))},[]);const U=k=>{if(k.preventDefault(),v(null),!u.trim()||!x.trim()){v("Preencha usuário e senha.");return}j(!0),fetch("/api/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({usuario:u.trim(),senha:x.trim()})}).then(T=>T.json()).then(T=>{if(j(!1),T&&T.status==="success"){const V=T.user;l(V),localStorage.setItem("operador_lanchonete",JSON.stringify(V)),V.role==="cozinha"?t("cozinha"):V.role==="tv"?t("chamada"):t("caixa")}else v(T.error||"Credenciais inválidas.")}).catch(T=>{j(!1),v("Erro de conexão com o servidor.")})},I=()=>{l(null),localStorage.removeItem("operador_lanchonete"),d(""),y(""),v(null)};A.useEffect(()=>(ie.on("connect",()=>{console.log("Conectado ao servidor Socket.io"),n(!0)}),ie.on("disconnect",()=>{console.log("Desconectado do servidor Socket.io"),n(!1)}),ie.on("pedidos_iniciais",k=>{f(Array.isArray(k)?k:[])}),ie.on("cardapio_inicial",k=>{h(P(k))}),ie.on("novo_pedido_criado",k=>{f(T=>[k,...T.filter(V=>V.id!==k.id)])}),ie.on("status_pedido_atualizado",k=>{f(T=>T.map(V=>V.id===k.id?k:V)),E(T=>T&&T.id===k.id?k:T)}),ie.on("pedido_chamado",k=>{E(k)}),ie.on("cardapio_atualizado",k=>{h(P(k))}),ie.on("novo_log_auditoria",k=>{b(T=>[k,...T.filter(V=>V.id!==k.id)])}),()=>{ie.off("connect"),ie.off("disconnect"),ie.off("pedidos_iniciais"),ie.off("cardapio_inicial"),ie.off("novo_pedido_criado"),ie.off("status_pedido_atualizado"),ie.off("pedido_chamado"),ie.off("cardapio_atualizado"),ie.off("novo_log_auditoria")}),[]);const m=(k,T)=>{ie.emit("criar_pedido",{...k,criadoPor:a?`${a.nome}`:"Caixa"},T)},O=(k,T)=>{ie.emit("mudar_status_pedido",{id:k,status:T,preparadoPor:a?`${a.nome}`:"Cozinha"})},W=(k,T,V)=>{f(M=>M.map(me=>{if(me.id!==k)return me;const at=(me.itens||[]).map((Pe,Lr)=>{if(Lr!==T)return Pe;const Gd=V!==void 0?V:!Pe.entregue;return{...Pe,entregue:Gd}}),_n=at.reduce((Pe,Lr)=>Pe+(Lr.quantidade||1),0),qa=at.filter(Pe=>Pe.entregue).reduce((Pe,Lr)=>Pe+(Lr.quantidade||1),0);let zn=me.status;qa>=_n?zn="entregue":qa>0?zn="entrega_parcial":(me.status==="entregue"||me.status==="entrega_parcial")&&(zn="em_preparo");const Ha={...me,itens:at,status:zn};return E(Pe=>Pe&&Pe.id===k?Ha:Pe),Ha})),ie.emit("alternar_item_entregue",{orderId:k,itemIndex:T,entregue:V,operadorNome:a?`${a.nome}`:"Atendente"}),fetch(`/api/orders/${k}/itens/${T}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({entregue:V,operadorNome:a?`${a.nome}`:"Atendente"})}).then(M=>M.ok?M.json():null).then(M=>{M&&M.order&&f(me=>me.map(at=>at.id===M.order.id?M.order:at))}).catch(M=>console.error("Erro ao alternar item:",M))},F=k=>{fetch("/api/menu/produto",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(k)}).then(T=>T.json()).catch(T=>console.error("Erro ao salvar produto:",T))},ke=k=>{fetch(`/api/menu/produto/${k}`,{method:"DELETE"}).then(T=>T.json()).catch(T=>console.error("Erro ao excluir produto:",T))},qe=k=>{fetch(`/api/menu/produto/${k}/disponivel`,{method:"PATCH"}).then(T=>T.json()).catch(T=>console.error("Erro ao alterar disponibilidade:",T))},He=k=>{fetch("/api/menu/categoria",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(k)}).then(T=>T.json()).catch(T=>console.error("Erro ao salvar categoria:",T))},z=k=>fetch(`/api/menu/categoria/${k}`,{method:"DELETE"}).then(T=>T.json());if(!a)return o.jsxs("div",{className:"login-gate-screen",children:[o.jsx("style",{children:`
          .login-gate-screen {
            min-height: 100vh;
            min-height: 100dvh;
            background: var(--app-canvas);
